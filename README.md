...
It comes with a suite of built-in Git / GitHub automation features, including pre-commit check, Continuous Integration (CI) through GitHub Actions, Issues / Pull requests (PRs) templates, and more.
